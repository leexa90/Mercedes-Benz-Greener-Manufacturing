...
def model():
    ...
    # compile this model
    model.compile(loss='logcosh', # one may use 'mean_absolute_error' as alternative
                  optimizer='adam',
    ...
    for tries in range(0,30):
        ...
        for validation in range(0,max_n):
            ...
            estimator.fit(
                X_tr, 
                y_tr, 
                epochs=88, # increase it to 20-100 to get better results
